<template>
  <j-modal centered :title="name + '选择'" :width="width" :visible="visible" switchFullscreen @ok="handleOk"
    ...
    <a-row :gutter="18">
      <a-col :span="16">
        ...
        <a-table size="middle" bordered :rowKey="rowKey" :columns="innerColumns" :dataSource="dataSource"
  ...
  export default {
    ...
    data() {
      return {
        ...
        renderEllipsis: (value) => ( < ellipsis length = {
            this.ellipsisLength
          } > {
            value
          } < /ellipsis>),
